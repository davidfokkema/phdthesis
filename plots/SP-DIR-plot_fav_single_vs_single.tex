...
\node[inner sep=0pt] (plot) {
                ...
                \nextgroupplot[
                    ...
                    % Draw non-empty bins in histogram
                                ...
                                \path[,fill,
                                      black!7]
                                    (axis cs:12.0, 42.0)
                                    rectangle (axis cs:13.0, 43.0);
                                \path[,fill,
                                      black!23]
                                    (axis cs:12.0, 44.0)
                                    rectangle (axis cs:13.0, 45.0);
                                \path[,fill,
                                      black!7]
                                    (axis cs:13.0, 7.0)
                                ...
                                \path[,fill,
                                      black!15]
                                    (axis cs:23.0, 40.0)
                                    rectangle (axis cs:24.0, 41.0);
                                \path[,fill,
                                      black!15]
                                    (axis cs:23.0, 44.0)
                                    rectangle (axis cs:24.0, 45.0);
                                \path[,fill,
                                      black!15]
                                    (axis cs:24.0, 7.0)
                                ...
                                \path[,fill,
                                      black!15]
                                    (axis cs:40.0, 41.0)
                                    rectangle (axis cs:41.0, 42.0);
                                \path[,fill,
                                      black!15]
                                    (axis cs:41.0, 18.0)
                                    rectangle (axis cs:42.0, 19.0);
                                \path[,fill,
                                      black!15]
                                    (axis cs:41.0, 19.0)
                                ...
                                \path[,fill,
                                      black!15]
                                    (axis cs:42.0, 9.0)
                                    rectangle (axis cs:43.0, 10.0);
                                \path[,fill,
                                      black!15]
                                    (axis cs:42.0, 23.0)
                                    rectangle (axis cs:43.0, 24.0);
                                \path[,fill,
                                      black!15]
                                    (axis cs:42.0, 28.0)
                                ...
                                \path[,fill,
                                      black!7]
                                    (axis cs:44.0, 17.0)
                                    rectangle (axis cs:45.0, 18.0);
                                \path[,fill,
                                      black!7]
                                    (axis cs:44.0, 18.0)
                                    rectangle (axis cs:45.0, 19.0);
                                \path[,fill,
                                      black!15]
                                    (axis cs:44.0, 35.0)
                ...
                \nextgroupplot[
                    ...
                    % Draw non-empty bins in histogram
                                ...
                                \path[,fill,
                                      black!6]
                                    (axis cs:-10.0, 170.0)
                                    rectangle (axis cs:0.0, 180.0);
                                \path[,fill,
                                      black!6]
                                    (axis cs:0.0, -180.0)
                                    rectangle (axis cs:10.0, -170.0);
                                \path[,fill,
                                      black!10]
                                    (axis cs:0.0, -70.0)
                                    rectangle (axis cs:10.0, -60.0);
                ...
                \nextgroupplot[
                    ...
                    % Draw non-empty bins in histogram
                                ...
                                \path[,fill,
                                      black!30]
                                    (axis cs:36.0, 7.0)
                                    rectangle (axis cs:37.0, 8.0);
                                \path[,fill,
                                      black!10]
                                    (axis cs:36.0, 10.0)
                                    rectangle (axis cs:37.0, 11.0);
                                \path[,fill,
                                      black!20]
                                    (axis cs:36.0, 23.0)
                                ...
                                \path[,fill,
                                      black!20]
                                    (axis cs:42.0, 11.0)
                                    rectangle (axis cs:43.0, 12.0);
                                \path[,fill,
                                      black!10]
                                    (axis cs:42.0, 20.0)
                                    rectangle (axis cs:43.0, 21.0);
                                \path[,fill,
                                      black!20]
                                    (axis cs:42.0, 26.0)
                ...
                \nextgroupplot[
                    ...
                    % Draw non-empty bins in histogram
                                ...
                                \path[,fill,
                                      black!12]
                                    (axis cs:37.0, 11.0)
                                    rectangle (axis cs:38.0, 12.0);
                                \path[,fill,
                                      black!18]
                                    (axis cs:37.0, 13.0)
                                    rectangle (axis cs:38.0, 14.0);
                                \path[,fill,
                                      black!12]
                                    (axis cs:37.0, 14.0)
                                ...
                                \path[,fill,
                                      black!12]
                                    (axis cs:39.0, 41.0)
                                    rectangle (axis cs:40.0, 42.0);
                                \path[,fill,
                                      black!25]
                                    (axis cs:40.0, 16.0)
                                    rectangle (axis cs:41.0, 17.0);
                                \path[,fill,
                                      black!25]
                                    (axis cs:40.0, 20.0)
                                ...
                                \path[,fill,
                                      black!6]
                                    (axis cs:43.0, 20.0)
                                    rectangle (axis cs:44.0, 21.0);
                                \path[,fill,
                                      black!12]
                                    (axis cs:43.0, 27.0)
                                    rectangle (axis cs:44.0, 28.0);
                                \path[,fill,
                                      black!6]
                                    (axis cs:43.0, 33.0)
                                    rectangle (axis cs:44.0, 34.0);
    ...
    \node[below] at (plot.south) { Shower angle [\si{\degree}] };
    \node[above, rotate=90] at (plot.west) { Shower angle [\si{\degree}] };
    \end{tikzpicture}
\end{sansmath}