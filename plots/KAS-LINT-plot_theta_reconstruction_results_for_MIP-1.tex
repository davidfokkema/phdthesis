    ...
    \begin{axis}[
            ...
            % Draw non-empty bins in histogram
                        ...
                        \path[,fill,
                              black!4]
                            (axis cs:0.0, 18.0)
                            rectangle (axis cs:1.0, 19.0);
                        \path[,fill,
                              black!2]
                            (axis cs:0.0, 26.0)
                            rectangle (axis cs:1.0, 27.0);
                        \path[,fill,
                              black!2]
                            (axis cs:0.0, 32.0)
                        ...
                        \path[,fill,
                              black!2]
                            (axis cs:4.0, 37.0)
                            rectangle (axis cs:5.0, 38.0);
                        \path[,fill,
                              black!2]
                            (axis cs:4.0, 38.0)
                            rectangle (axis cs:5.0, 39.0);
                        \path[,fill,
                              black!1]
                            (axis cs:4.0, 39.0)
                        ...
                        \path[,fill,
                              black!1]
                            (axis cs:25.0, 1.0)
                            rectangle (axis cs:26.0, 2.0);
                        \path[,fill,
                              black!1]
                            (axis cs:25.0, 2.0)
                            rectangle (axis cs:26.0, 3.0);
                        \path[,fill,
                              black!2]
                            (axis cs:25.0, 3.0)
                        ...
                        \path[,fill,
                              black!1]
                            (axis cs:32.0, 1.0)
                            rectangle (axis cs:33.0, 2.0);
                        \path[,fill,
                              black!1]
                            (axis cs:32.0, 4.0)
                            rectangle (axis cs:33.0, 5.0);
                        \path[,fill,
                              black!1]
                            (axis cs:32.0, 7.0)
                        ...
                        \path[,fill,
                              black!1]
                            (axis cs:39.0, 10.0)
                            rectangle (axis cs:40.0, 11.0);
                        \path[,fill,
                              black!2]
                            (axis cs:39.0, 11.0)
                            rectangle (axis cs:40.0, 12.0);
                        \path[,fill,
                              black!1]
                            (axis cs:39.0, 16.0)
                            rectangle (axis cs:40.0, 17.0);
                        \path[,fill,
                              black!1]
                            (axis cs:39.0, 17.0)
                            rectangle (axis cs:40.0, 18.0);
                        \path[,fill,
                              black!2]
                            (axis cs:39.0, 21.0)
