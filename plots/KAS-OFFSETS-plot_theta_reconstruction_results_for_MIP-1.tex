    ...
    \begin{axis}[
            ...
            % Draw non-empty bins in histogram
                        ...
                        \path[,fill,
                              black!1]
                            (axis cs:31.0, 2.0)
                            rectangle (axis cs:32.0, 3.0);
                        \path[,fill,
                              black!1]
                            (axis cs:31.0, 7.0)
                            rectangle (axis cs:32.0, 8.0);
                        \path[,fill,
                              black!3]
                            (axis cs:31.0, 11.0)
